let stocks = {
  ...
  .then(()=>{return order(2000,()=>console.log("Fruit was chopped"));
            })
  ...
  .then(()=>{return order(2000, ()=>console.log(`${stocks.holder[0]} was selected`));
            })
  
  .then(()=>{return order(3000, ()=>console.log(`${stocks.toppings[0]} was selected as toppings`));
            })
  ...
  .finally(()=>{
    console.log("our day ended shop closed");
  });
